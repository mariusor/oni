...
require (
	...
	github.com/go-ap/client v0.0.0-20250523112049-cd806e9e8517
	...
	github.com/go-ap/processing v0.0.0-20250523115217-ce62d272c341
	github.com/go-ap/storage-fs v0.0.0-20250523115327-92cf558a25ec
